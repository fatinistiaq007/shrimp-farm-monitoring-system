  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="index_new.php" class="logo" style= "color: #641E16  "><b>water quality dashboard</b></a>
            <!--logo end-->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="mt">
                      <a class="active" href="index_new.php">
                  ...
                  <li class="sub-menu">
                      <!--<a href="javascript:;" >-->
						  ...
						  <li><a  href="radial-component.html">Gauges</a></li>
                  ...
                  <li class="sub-menu">
						  ...
						  <li><a  href="ReportCsv\csvtosql\index.php">Report</a></li>
...
<div class="mySlides fade">
  ...
  <img src="slide/8.jpg" style="width:135%">
  <div class="text"></div>
</div>

<div class="mySlides fade">
  <div class="numbertext"></div>
  <img src="slide/9.jpg" style="width:135%">
  <div class="text"></div>
</div>

<div class="mySlides fade">
  <div class="numbertext"></div>
  <img src="slide/10.jpg" style="width:135%">
  <div class="text"></div>
</div>
...
<body onload="init();" style= "background: url(slide/background.jpg); background-size: 100%; background-color: white;">
<!--<pre></pre>-->
